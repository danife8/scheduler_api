...
RSpec.describe '/specialists' do
  ...
  # Api::V1::SpecialistsController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get api_v1_specialists_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
      ...
      it 'creates a new Specialist' do
        expect do
          post api_v1_specialists_url,
               params: { specialist: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      ...
      it 'renders a JSON response with errors for the new specialist' do
        post api_v1_specialists_url,
             params: { specialist: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with valid parameters' do
      ...
      it 'updates the requested specialist' do
        ...
        patch api_v1_specialist_url(specialist),
              params: { specialist: new_attributes }, headers: valid_headers, as: :json
        specialist.reload
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested specialist' do
      specialist = Specialist.create! valid_attributes
      expect do
        delete api_v1_specialist_url(specialist), headers: valid_headers, as: :json
      end.to change(Specialist, :count).by(-1)
    end
  end
end
