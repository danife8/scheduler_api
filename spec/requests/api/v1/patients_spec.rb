...
RSpec.describe '/patients' do
  ...
  # Api::V1::PatientsController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get api_v1_patients_url, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested patient' do
      patient = Patient.create! valid_attributes
      expect do
        delete api_v1_patient_url(patient), headers: valid_headers, as: :json
      end.to change(Patient, :count).by(-1)
    end
  end
end
